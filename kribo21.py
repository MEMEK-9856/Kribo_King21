...
def dump(token,nama,ttl):
	...
	os.system("clear")
	jalan("""%s
 _  __     _ _                ____  _                   | |/ /_ __(_) |__   ___      |___ \/ |
...
|_|\_\_|  |_|_.__/ \___/     |_____|_|
	...
	print(f"\n[{biruM}/\{putih}] CRACK ID BERDASARKAN [{biruM}/\{putih}]\n[{biruL}01{putih}] CRACK FROM FRIENDS LIST\n[{biruL}02{putih}] CRACK FROM FOLLOWERS LIST\n[{biruL}03{putih}] CRACK FROM LIKES POST\n[{biruL}04{putih}] CARI TARGET CRACK\n[{biruL}05{putih}] CEK HASIL CRACK\n[{biruL}UA{putih}] SETTINGS USERAGENT\n")
